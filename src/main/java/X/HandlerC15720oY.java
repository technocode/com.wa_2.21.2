...
public class HandlerC15720oY extends Handler {
    public final /* synthetic */ C15750ob A00;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HandlerC15720oY(C15750ob r1, Looper looper) {
        super(looper);
        this.A00 = r1;
    }
    ...
    public void handleMessage(android.os.Message r11) {
        ...
        L_0x000b:
            ...
            monitor-enter(r1)
            java.util.ArrayList r0 = r9.A02     // Catch:{ all -> 0x004b }
            int r8 = r0.size()     // Catch:{ all -> 0x004b }
            if (r8 > 0) goto L_0x0018
            monitor-exit(r1)     // Catch:{ all -> 0x004b }
            goto L_0x004a
        L_0x0018:
            X.0oZ[] r7 = new X.C15730oZ[r8]     // Catch:{ all -> 0x004b }
        ...
        L_0x004b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.HandlerC15720oY.handleMessage(android.os.Message):void");
    }
}
