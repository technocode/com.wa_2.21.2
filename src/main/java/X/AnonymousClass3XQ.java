...
public class AnonymousClass3XQ extends AbstractC68463Dh {
    public final /* synthetic */ AnonymousClass0GT A00;
    public final /* synthetic */ C03340Fu A01;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnonymousClass3XQ(C03340Fu r1, Context context, AnonymousClass02M r3, AnonymousClass04j r4, AnonymousClass0GP r5, AnonymousClass0GT r6) {
    ...
    public void A03(AnonymousClass0M5 r4) {
        AnonymousClass3DL r2;
        AnonymousClass0GT r0 = this.A00;
        if (r0 != null) {
            r2 = new AnonymousClass3DL(r0);
        } else {
            r2 = null;
        }
