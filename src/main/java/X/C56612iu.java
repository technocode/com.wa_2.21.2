...
public class C56612iu implements AbstractC03150Ez {
    public int A00 = -1;
    public int A01;
    ...
    public C56612iu(C04420Kh r2, C40531tQ r3, C56862jJ r4) {
        this.A03 = r2;
        this.A02 = r3;
        this.A04 = r4;
    }
    ...
    public void A1e(Object obj) {
        ...
        if (intValue != this.A00) {
            ...
            if (intValue >= this.A01 + 5) {
                this.A01 = intValue;
                StringBuilder A0S = AnonymousClass008.A0S("mediajobmanager/upload/progress for ");
            ...
            C04430Ki.A01(number, r1, new C56532im(r2));
            r3.A05.A07(r1.A01, 8);
        }
    }
}
