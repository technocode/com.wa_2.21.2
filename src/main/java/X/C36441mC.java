...
public final class C36441mC extends AnonymousClass066 {
    public static final Parcelable.Creator CREATOR = new AnonymousClass1CN();
    public final int A00;
    public final boolean A01;

    public C36441mC(int i, boolean z) {
        this.A00 = i;
        this.A01 = z;
    }
