...
public final /* synthetic */ class C38971qk implements AnonymousClass35j {
    ...
    public /* synthetic */ C38971qk(C04350Ka r1, boolean z, List list, String str, AnonymousClass1NW r5, Uri uri, AbstractC004502c r7) {
        this.A03 = r1;
        this.A06 = z;
        this.A05 = list;
        this.A04 = str;
    ...
    public final void AG2(File file) {
        ...
        List list = this.A05;
        String str = this.A04;
        AnonymousClass1NW r1 = this.A02;
        Uri uri = this.A00;
        AbstractC004502c r3 = this.A01;
        try {
            r5.A07(z, list, file, AnonymousClass1XO.A04, true, str, null, false);
            r1.ALY(uri);
        } catch (IOException e) {
