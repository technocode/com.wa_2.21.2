...
public final class C14960nA {
    ...
    public static float A01(ViewConfiguration viewConfiguration, Context context) {
        ...
        return A00(viewConfiguration, context);
    }

    public static int A02(ViewConfiguration viewConfiguration) {
    ...
    public static boolean A03(ViewConfiguration viewConfiguration, Context context) {
        if (Build.VERSION.SDK_INT >= 28) {
