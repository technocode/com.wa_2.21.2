...
public final class C75823dY extends AnonymousClass078 implements AnonymousClass077 {
    public static final C75823dY A04;
    ...
    public int A90() {
        ...
        if ((this.A00 & 2) == 2) {
            i2 += AbstractC11750gu.A09(16, this.A03);
        }
        if ((this.A00 & 4) == 4) {
