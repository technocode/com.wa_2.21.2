...
public class C07530Ya extends AutoCompleteTextView implements AbstractC05570Pf {
    public static final int[] A02 = {16843126};
    public final AnonymousClass0ZW A00;
    public final AnonymousClass0ZX A01;

    public C07530Ya(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.autoCompleteTextViewStyle);
    }

    public C07530Ya(Context context, AttributeSet attributeSet, int i) {
