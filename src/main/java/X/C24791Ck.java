...
public class C24791Ck {
    ...
    public static boolean A00(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return A01(packageInfo, A02, A03);
        }
        return A01(packageInfo, A02);
    }

    public static boolean A01(PackageInfo packageInfo, byte[]... bArr) {
        Signature[] signatureArr = packageInfo.signatures;
    ...
    public final boolean A02() {
        ...
        try {
            packageInfo = C04660Lg.A00(this.A00).A00.getPackageManager().getPackageInfo("com.google.android.wearable.app.cn", 64);
        ...
        if (AnonymousClass0LV.A01(this.A00)) {
            return A00(packageInfo, true);
        }
        boolean A002 = A00(packageInfo, false);
        if (!A002 && A00(packageInfo, true)) {
