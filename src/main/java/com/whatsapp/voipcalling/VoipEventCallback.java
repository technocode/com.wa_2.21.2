...
public interface VoipEventCallback {
    ...
    void callEnding(Voip.CallLogInfo callLogInfo, int i);

    void callMissed(String str, String str2, String str3, String str4, int i, long j, boolean z, CallGroupInfo callGroupInfo, boolean z2);
