...
public class CircularProgressBar extends ProgressBar {
    ...
    public CircularProgressBar(Context context, AttributeSet attributeSet) {
        ...
        this.A08 = C004302a.A00(context, R.color.circular_progress_bar_center_text);
        this.A0C = C004302a.A00(context, R.color.circular_progress_bar_bar);
        this.A0B = C004302a.A00(context, R.color.circular_progress_bar_background);
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C06140Ry.A0U);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.A0B != 0) {
            ...
            canvas.drawArc(this.A0I, ((((float) getProgress()) * 360.0f) / ((float) getMax())) + 270.0f, 360.0f - ((((float) getProgress()) * 360.0f) / ((float) getMax())), false, paint);
        }
        int i3 = this.A0A;
        if (i3 != 0) {
            paint.setColor(i3);
        ...
        if (this.A0G) {
            ...
            canvas.drawCircle((float) ((Math.sin(d) * ((double) this.A04)) + ((double) rectF.centerX())), (float) (((double) rectF.centerY()) - (Math.cos(d) * ((double) this.A04))), 10.0f, paint);
        }
        if (this.A0F != null) {
    ...
    public void setCenterText(String str) {
        this.A0F = str;
        this.A07 = C002301g.A0K.A00 * 30.0f;
    }
